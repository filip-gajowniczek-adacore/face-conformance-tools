package body System.Val_Util is
   ...
   procedure Normalize_String (S : in out String; F, L : out Integer) is
   begin
   ...
   procedure Scan_Sign
     (Str   :     String; Ptr : not null access Integer; Max : Integer;
      Minus : out Boolean; Start : out Positive)
   is
   begin
   ...
   is
   begin
      return raise Program_Error with "Unimplemented function Scan_Exponent";
   end Scan_Exponent;
   ...
   procedure Scan_Underscore
     (Str : String; P : in out Natural; Ptr : not null access Integer;
      Max : Integer; Ext : Boolean)
   is
   begin
