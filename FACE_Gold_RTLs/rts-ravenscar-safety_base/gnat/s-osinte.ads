...
package System.OS_Interface is
   ...
   subtype int             is Integer; -- Interfaces.C.int;
   subtype unsigned        is Integer;  -- Interfaces.C.unsigned;
   ...
   type Signal is new int range 0 .. 63; -- Interfaces.C."-" (NSIG, 1);
   ...
   ERROR : constant STATUS := -1; -- Interfaces.C.int (-1);
   ...
   function Current_CPU return Short_Integer; -- Multiprocessors.CPU;
