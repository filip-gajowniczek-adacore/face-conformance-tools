package body System.Img_LLB is
   ...
   procedure Set_Image_Based_Long_Long_Integer
     (V :        Long_Long_Integer; B : Natural; W : Integer; S : out String;
      P : in out Natural)
   is
   begin
      raise Program_Error
        with "Unimplemented procedure Set_Image_Based_Long_Long_Integer";
   ...
   procedure Set_Image_Based_Long_Long_Unsigned
     (V : System.Unsigned_Types.Long_Long_Unsigned; B : Natural; W : Integer;
      S : out String; P : in out Natural)
   is
   begin
      raise Program_Error
        with "Unimplemented procedure Set_Image_Based_Long_Long_Unsigned";
