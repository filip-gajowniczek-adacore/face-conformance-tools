package body System.Img_Enum_New is
   ...
   is
   begin
      raise Program_Error with "Unimplemented procedure Image_Enumeration_8";
   ...
   is
   begin
      raise Program_Error with "Unimplemented procedure Image_Enumeration_16";
   ...
   is
   begin
      raise Program_Error with "Unimplemented procedure Image_Enumeration_32";
