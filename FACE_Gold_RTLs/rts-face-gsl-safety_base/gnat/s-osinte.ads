...
package System.OS_Interface is
   ...
   subtype long is integer; --  Interfaces.C.long;

   subtype LARGE_INTEGER is Integer; --  System.Win32.LARGE_INTEGER;
   ...
   Null_Void : constant Address := System.Null_Address;

   -------------------------
   -- Handles for objects --
   -------------------------

   subtype Thread_Id is Address; -- Win32.HANDLE;
