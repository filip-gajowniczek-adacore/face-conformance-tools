package body System.Img_LLW is
   ...
   begin
      ...
      raise Program_Error with "Unimplemented procedure Set_Image_Width_Long_Long_Integer";
   ...
   begin
      --  Generated stub: replace with real body!
      raise Program_Error with "Unimplemented procedure Set_Image_Width_Long_Long_Unsigned";
