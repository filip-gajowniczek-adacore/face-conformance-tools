package body System.Img_LLU is
   ...
   begin
      ...
      raise Program_Error with "Unimplemented procedure Image_Long_Long_Unsigned";
   ...
   begin
      --  Generated stub: replace with real body!
      raise Program_Error with "Unimplemented procedure Set_Image_Long_Long_Unsigned";
